<template>
  <div class="relative mx-auto">
    ...
    <div class="container absolute inset-0 flex flex-col items-start justify-center p-8">
      ...
      <ion-router-link class="px-6 py-3 font-bold text-white bg-gray-800 rounded-xl hover:bg-gray-800" to="/products">Shop now</ion-router-link>
    </div>
  </div>
</template>
