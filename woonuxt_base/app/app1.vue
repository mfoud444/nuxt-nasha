...
<div class="sticky  top-0  z-40 pb-1">
...
color="false"<img src="/images/loading1.gif" alt="Loading" class="m-auto" /> -->
</NuxtLoadingIndicator>
...
<div class="sticky  bottom-0  z-40 pt-2 overflow-x">
  ...
  <div :class='isNative ? "flex-1 flex flex-col" : "flex-1 flex flex-col"'>
    <NuxtPage/>
    <Transition name="fade">
...
<div v-if="isNative" class="sticky  bottom-0  z-40 pt-2">
...
html,
body {
  @apply bg-gray-100 text-gray-900 mx-0 md:container;
